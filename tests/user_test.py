...
def test_successful_users_all():
    requests.delete(f'{BASE_URL}/clear/v1')
    user_woody_reg = {"email": "sheriff.woody@andysroom.com", "password": "qazwsx!!", "name_first": "sheriff",
                      "name_last": "woody"}
    user_buzz_reg = {"email": "buzz.lightyear@starcommand.com", "password": "qazwsx@@", "name_first": "buzz",
                     "name_last": "lightyear"}
